...
def main():
	...
	znData = pd.to_numeric(filteredExcelDataZn["Bank A Airflow"], errors='coerce')
	...
	plt.figure()
	plt.subplot(211)
	lineZn, = plt.plot(timeZnData, znData, color='k', label="Bank A Airflow")
	...
	plt.savefig("bankAAirFlowA361.png")
	plt.show()
